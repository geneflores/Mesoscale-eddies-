...
fechasModelo <- c("Modelo 28-Nov-2019", 
                  "Modelo 10-Ene-2020", 
                  "Modelo 08-Feb-2020")

fechasBoyas <- c("Boya 29-Nov-2019", 
                 "Boya 07-Ene-2020", 
                 "Boya 09-Feb-2020")
...
r3_coord_a <- coordenadas[5]
r3_coord_b <- coordenadas[6]
...
diferenciasMinimas <- c(max(Var[[3]][[1]], na.rm = TRUE),
                        ...
                        max(Var[[3]][[3]], na.rm = TRUE),
                        min(Var[[3]][[3]], na.rm = TRUE)
)
...
valoresMinimos <- c(max(Var[[2]][[1]], na.rm = TRUE),
                        ...
                        max(Var[[2]][[3]], na.rm = TRUE),
                        min(Var[[2]][[3]], na.rm = TRUE)
)
...
boyasMinimos <- c(max(Var[[1]][[1]], na.rm = TRUE),
                    ...
                    max(Var[[1]][[3]], na.rm = TRUE),
                    min(Var[[1]][[3]], na.rm = TRUE)
)
...
# Configuración de tamaño y resolución
  png(file = nombreArchivo, 
      width = 35, height = 30, units = "in", res = 400)
  ...
  filled.contour4(x = x_vals, y = prof, rot90(Var[[2]][[1]], 2),
                  ...
                  plot.axes = {
                    ...
                    abline(v = coordenadas[1], 
                           col = 'black', 
                           lwd = 3, 
                           lty = 1)
                    abline(v = coordenadas[2], 
                           col = 'black', 
                           lwd = 3, 
                           lty = 1)
                    text(x = xpp, y = -100, 
  ...
  par(new = "TRUE", 
      plt = c(0.82, 0.96, 0.7, 0.9), 
      las = 1)
  
  plot(x = Var[[1]][[1]], y = pres_boyas$p1,
  ...
  filled.contour4(x = x_vals, y = prof, rot90(Var[[2]][[2]],2),
                  ...
                  plot.axes = {
                    ...
                    axis(2)
                    grid(nx = NULL, ny = NULL, col = "#2B2B2B", lty = "dotted")
                    abline(v = coordenadas[3], 
                           col = 'black', 
                           lwd = 3, 
                           lty = 1)
                    abline(v = coordenadas[4], 
                           col = 'black', 
                           lwd = 3, 
                           lty = 1)
                    text(x = xpp, y = -100, 
  ...
  par(new = "TRUE", 
      plt = c(0.82, 0.96, 0.4, 0.6), 
      las = 1)
  
  plot(x = Var[[1]][[2]], y = pres_boyas$p2,
  ...
  par(new = "TRUE", 
      plt = c(0.05, 0.32, 0.1, 0.3), 
      las = 1, 
      cex = 2.3)
  
  
  
  filled.contour4(x = x_vals, y = prof, rot90(Var[[2]][[3]],2),
                  color.palette = palD,
                  plot.title = title(main = fechasModelo[3], 
                                     xlab = "Distancia [Km]",
                                     cex.main = 1.2),
                  plot.axes = {
                    axis(1, at = secuenciaX) 
                    axis(2)
                    grid(nx = NULL, ny = NULL, col = "#2B2B2B", lty = "dotted")
                    abline(v = coordenadas[5], 
                           col = 'black', 
                           lwd = 3, 
                           lty = 1)
                    abline(v = coordenadas[6], 
                           col = 'black', 
                           lwd = 3, 
                           lty = 1)
                    text(x = xpp, y = -100, 
  ...
  par(new = "TRUE", 
      plt = c(0.42, 0.69, 0.1, 0.3), 
      las = 1)
  
  
  filled.contour4(x = x_vals, y = prof, rot90(Var[[3]][[3]],2),
                  color.palette = palGENE,
                  plot.title = title(main = titulo, 
                                     xlab = "Distancia [Km]",
                                     cex.main = 1.2),
  ...
  par(new = "TRUE", 
      plt = c(0.82, 0.96, 0.1, 0.3), 
      las = 1)
  
  plot(x = Var[[1]][[3]], y = pres_boyas$p3,
       type = "l", main = fechasBoyas[3], 
       xlab = unidades,
       ylab = "",
       ylim = c(min(prof), 0), yaxs = "i", 
       xlim = c(floor(min(boyasMinimos)), 
