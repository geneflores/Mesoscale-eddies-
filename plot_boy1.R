...
#EXTRAER CONJUNTO DE DATOS ORGANIZADO 
setwd("C:/Users/genef/Documents/Remolinos/rutinas/NUEVOS")

nombre <- c("alldatos135")
...
fechasModelo <- c("Modelo 20-Jun-2019")

fechasBoyas <- c("Boya 16-Jun-2019")

#Posición de la letra en el eje x 
xp <- 810 
...
# Configuración de tamaño y resolución
  png(file = nombreArchivo, 
      width = 35, height = 10, units = "in", res = 400)
